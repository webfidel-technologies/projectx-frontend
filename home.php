...
<div class="page-wraper">
						...
						<div class="browse-category-menu">
							...
							<div class="category-menu-items" style="display: none;">
								<ul class="nav navbar-nav">
									...
									<li class="menu-items">
										<a href="javascript:void(0);">
											<img class="me-3" src="images/svg/menu.svg" alt="">
	...
	<div class="page-content bg-white">
									...
									<div class="col-xl-6 col-md-6 col-sm-7 align-self-center">
										<div class="swiper-content">
											<div class="content-info">
												<h1 class="offer-title mb-0" data-swiper-parallax="-20">SALE 50%</h1>
												<h2 class="title mb-2" data-swiper-parallax="-20">For Meditation, yoga, Asana.</h2>
												<p class="sub-title mb-0" data-swiper-parallax="-40">No code need. Plus free shippng on $99+ orders!</p>												
											</div>
											<div class="content-btn" data-swiper-parallax="-60">
												<a class="btn btn-secondary  me-3" href="shop-cart.html">ADD TO CART</a>
												<a class="btn btn-outline-secondary " href="product-default.html">VIEW DETAILS</a>
											</div>
										</div>
									</div>
							...
							<div class="banner-content">
								<div class="row">
									<div class="col-xl-6 col-md-6 col-sm-7 align-self-center">
										<div class="swiper-content">
											<div class="content-info">
												<h1 class="offer-title mb-0" data-swiper-parallax="-20">SALE 40%</h1>
												<h2 class="title mb-2" data-swiper-parallax="-20">For Gym, yoga, running.</h2>
												<p class="sub-title mb-0" data-swiper-parallax="-40">No code need. Plus free shippng on $99+ orders!</p>												
											</div>
											<div class="content-btn" data-swiper-parallax="-60">
												<a class="btn btn-secondary  me-3" href="shop-cart.html">ADD TO CART</a>
			...
			<div class="container-fluid p-3">
				<div class="swiper swiper-product">
					<div class="swiper-wrapper product-style2">
						<div class="swiper-slide">
							<div class="product-box style-2 wow fadeInUp" data-wow-delay="0.1s" style="background-image: url('images/gym/1.png');">
						...
						<div class="swiper-slide">
							<div class="product-box style-2 wow fadeInUp" data-wow-delay="0.2s" style="background-image: url('images/gym/2.png');">
								<div class="product-content">
									<div class="main-content">
						...
						<div class="swiper-slide">
							<div class="product-box style-2 wow fadeInUp" data-wow-delay="0.3s" style="background-image: url('images/gym/3.png');">
								<div class="product-content">
									<div class="main-content">
						...
						<div class="swiper-slide">
							<div class="product-box style-2 wow fadeInUp" data-wow-delay="0.4s" style="background-image: url('images/gym/4.png');">
								<div class="product-content">
									<div class="main-content">
			...
			<div class="container">
				...
				<div class="row gx-xl-4 g-3">
					<div class="col-xl-4 col-lg-4 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.2s">
						<div class="category-product left">
							<a href="javascript:void(0);">								
								...
								<div class="category-badge">Exercise Ball</div>
							</a>
						</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.3s">
						<div class="category-product left">
							<a href="javascript:void(0);">
								...
								<div class="category-badge">Fitness trackers</div>
							</a>
						</div>
					</div>
					<div class="col-xl-5 col-lg-4 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.4s">
						<div class="category-product left">
							<a href="javascript:void(0);">
								...
								<div class="category-badge">Yoga Ring</div>
							</a>
						</div>
					</div>
					<div class="col-xl-4 col-lg-4 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.5s">
						<div class="category-product right">
							<a href="javascript:void(0);">
								...
								<div class="category-badge">Dumbbells</div>
							</a>
						</div>
					</div>
					<div class="col-xl-5 col-lg-4 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.6s">
						<div class="category-product right">
							<a href="javascript:void(0);">
								<img src="images/category/pic5.jpg" alt="">
								<div class="category-badge">Yoga mats</div>
							</a>	
						</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.7s">
						<div class="category-product right">
							<a href="javascript:void(0);">
								...
								<div class="category-badge">Protein</div>
							</a>	
						</div>
					</div>
				</div>
		...
		<!-- icon-box1 -->
		<section class="content-inner-3 overlay-white-dark" style="background-image: url('images/background/bg2.jpg'); background-repeat: no-repeat; background-size: cover;">
			<div class="container">
						...
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide">
								<div class="shop-card wow fadeInUp" data-wow-delay="0.3s">
									...
									<div class="dz-content">
										<h5 class="title"><a href="shop-list.html">Yoga mats and accessories</a></h5>
										<ul class="star-rating">
											<li>
												<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M7.24805 0.734375L9.22301 5.01608L13.9054 5.57126L10.4436 8.77267L11.3625 13.3975L7.24805 11.0944L3.13355 13.3975L4.0525 8.77267L0.590651 5.57126L5.27309 5.01608L7.24805 0.734375Z" fill="#FF8A00"></path>
		...
		<!-- Video Bx Start-->
		<section class="content-inner overlay-black-light" style="background-image: url('images/background/bg3.jpg'); background-repeat: no-repeat; background-size: cover;">
			<div class="container">
				<div class="row align-items-center dz-content-bx style-1">
					<div class="col-xl-7 col-lg-7 m-b30 wow fadeInLeft" data-wow-delay="0.1s">
					...
					<div class="col-xl-5 col-lg-5 m-b30 wow fadeInRight" data-wow-delay="0.2s">
						<div class="inner-content">
							<div class="section-head">
								<h2 class="title">Enjoy the best quality and features made by MoonCart.</h2>
								<p class="max-w500">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using.</p>
							</div>
							<a href="shop-list.html" class="btn text-uppercase btn-outline-light me-3">Shop Now</a>
							<a href="product-default.html" class="btn text-uppercase btn-outline-light">View Details</a>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="content-inner-1">
			<div class="container">
				<div class="row">
					<div class="col-xl-3">
						<div class="row">
							<div class="col-xl-12 col-md-6 col-sm-6 wow fadeInLeft" data-wow-delay="0.1s">
								<div class="offer-card text-center">
									<div class="dz-media">
										<img src="images/offer/pic1.jpg" alt="">
									</div>
									<div class="offer-content">
										<h3 class="title">Yoga mats and accessories</h3>
										<span class="offer">UP TO 60% OFF</span>
										<a href="shop-list.html" class="btn btn-outline-secondary">Shop Now</a>
									</div>
								</div>
							</div>
							<div class="col-xl-12 col-md-6 col-sm-6 wow fadeInLeft" data-wow-delay="0.2s">
								<div class="offer-card text-center">
									<div class="dz-media">
										<img src="images/offer/pic2.jpg" alt="">
									</div>
									<div class="offer-content">
										<h3 class="title">Plant-based protein supplements</h3>
										<span class="offer">UP TO 60% OFF</span>
										<a href="shop-list.html" class="btn btn-outline-secondary">Shop Now</a>
									</div>
								</div>
					...
					<div class="col-xl-9">
						...
						<div class="clearfix">
							<ul id="masonry" class="row g-xl-4 g-3">
								<li class="card-container col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 Begs">
									<div class="shop-card">
										<div class="dz-media">
								...
								<li class="card-container col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 Bottle">
									<div class="shop-card">
										<div class="dz-media">
											<img src="images/shop/product/13.png" alt="image">
											<div class="shop-meta">
												<a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
													<i class="fa-solid fa-eye d-md-none d-block"></i>
													<span class="d-md-block d-none">Quick View</span>
										...
										<div class="dz-content">
											<h5 class="title"><a href="shop-list.html">Home fitness equipment</a></h5>
											<ul class="star-rating">
												<li>
													<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
														<path d="M7.24805 0.734375L9.22301 5.01608L13.9054 5.57126L10.4436 8.77267L11.3625 13.3975L7.24805 11.0944L3.13355 13.3975L4.0525 8.77267L0.590651 5.57126L5.27309 5.01608L7.24805 0.734375Z" fill="#FF8A00"/>
								...
								<li class="card-container col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 Bottle">
									<div class="shop-card">
										<div class="dz-media">
											<img src="images/shop/product/14.png" alt="image">
											<div class="shop-meta">
												<a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
													<i class="fa-solid fa-eye d-md-none d-block"></i>
													<span class="d-md-block d-none">Quick View</span>
								...
								<li class="card-container col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 Begs">
									<div class="shop-card">
										<div class="dz-media">
											<img src="images/shop/product/15.png" alt="image">
											<div class="shop-meta">
												<a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
													<i class="fa-solid fa-eye d-md-none d-block"></i>
													<span class="d-md-block d-none">Quick View</span>
								...
								<li class="card-container col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 Toothbrushes">
									<div class="shop-card">
										<div class="dz-media">
											<img src="images/shop/product/16.png" alt="image">
											<div class="shop-meta">
												<a href="javascript:void(0);" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#exampleModal">
													<i class="fa-solid fa-eye d-md-none d-block"></i>
													<span class="d-md-block d-none">Quick View</span>
										...
										<div class="dz-content">
											<h5 class="title"><a href="shop-wishlist.html">Fitness trackers</a></h5>
											<ul class="star-rating">
												<li>
													<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
														<path d="M7.24805 0.734375L9.22301 5.01608L13.9054 5.57126L10.4436 8.77267L11.3625 13.3975L7.24805 11.0944L3.13355 13.3975L4.0525 8.77267L0.590651 5.57126L5.27309 5.01608L7.24805 0.734375Z" fill="#FF8A00"/>
		...
		<!-- Newsletter -->
		<section class="overlay-black-light newsletter-wrapper style-2" style="background-image: url('images/background/bg4.jpg'); background-repeat: no-repeat; background-size: cover;">
			<div class="container">
		...
		<section class="content-inner overlay-white-middle">
			<div class="container">
				<div class="section-head style-2 wow fadeInUp" data-wow-delay="0.1s">
					...
					<a href="post-standard.html" class="text-secondary font-14 d-flex align-items-center gap-1 text-nowrap">See all Post 
						<i class="icon feather icon-chevron-right font-18"></i>
					</a>					
				</div>
