        ...
        <main class="2xl:ml-[--w-side] xl:ml-[--w-side-md] md:ml-[--w-side-small]">
            ...
            <?php
                ...
                if ($userId) {
                    ...
                    $apiEndpoint = "https://getbanny-backend.up.railway.app/api/V1/models/" . $userId;
                                ...
                                <div class="py-6 relative">
                                    ...
                                    <div class="flex md:gap-16 gap-4 max-md:flex-col">
                                        ...
                                        <div class="max-w-2x flex-1">
                                            <h3 class="md:text-xl text-base font-semibold text-black dark:text-white"> '. htmlspecialchars($data['data']['display_name']) .' </h3>
                                            ...
                                            <div class="flex md:items-end justify-between md:mt-8 mt-4 max-md:flex-col gap-4">
                                                <div class="flex sm:gap-10 gap-6 sm:text-sm text-xs max-sm:absolute max-sm:top-10 max-sm:left-36">
                                                    <div>
                                                        <p>Profile Views</p>
                                                        <h3 class="sm:text-xl sm:font-bold mt-1 text-black dark:text-white text-base font-normal">'. htmlspecialchars($data['data']['visit_count']) .'</h3>
                                                    </div>
                                                </div>
                                                <div class="flex items-center gap-3 text-sm">
                                                    <button type="submit" class="button text-gray-600 bg-slate-200 hidden">Follow</button>

                                                    <button type="submit" class="button bg-pink-600 text-white">Contact</button>
