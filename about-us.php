...
<div class="page-wraper">
	...
	<div class="page-content">
		<div class="content-inner whatwedo-section" style="background-image: url('images/background/bg7.jpg');"></div>
		<section class="content-inner about-style3">
			<div class="container">
				<div class="row g-0">
					<div class="col-lg-7 col-md-12 col-sm-12">
						<div class="whatwedo-box">
							<h2 class="dz-title wow fadeInUp" data-wow-delay="0.1s">The Impact of What We Do How We Make a Difference</h2>
							<nav aria-label="breadcrumb" class="breadcrumb-row wow fadeInUp" data-wow-delay="0.1s">
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html"> Home</a></li>
									<li class="breadcrumb-item">About us</li>
								</ul>
							</nav>
							<div class="dz-media wow fadeInUp" data-wow-delay="0.3s">
					...
					<div class="col-lg-5 col-md-12 col-sm-12 p-a0">
						<div class="about-thumb wow fadeInUp" data-wow-delay="0.8s">
							<img src="images/lady3.png" alt="">
						</div>
					</div>
				</div>
			</div>
		...
		<section class="get-in-touch bg-light">
			<div class="m-r100 m-md-r0 m-sm-r0 wow fadeInUp" data-wow-delay="0.1s">
				<h3 class="dz-title mb-lg-0 mb-3">Questions ?
					<span>Our experts will help find the grar that’s right for you</span>
				</h3>
			</div>
			<a href="contact-us-1.html" class="btn btn-secondary wow fadeInUp" data-wow-delay="0.2s">Get In Touch</a>
		</section>
			...
			<div class="container">
				<div class="section-inner">
					...
					<div class="row gx-3 companies-inner">
						...
						<div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.9s">
							<a href="javascript:void(0);" class="companies-wrapper">
								<div class="companies-media">
