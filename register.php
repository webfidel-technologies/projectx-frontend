						...
						<div class="login-area">
							...
							<form id="registrationForm" method="POST">
								<div class="m-b25">
									...
									<input name="display_name" required="" class="form-control" placeholder="Username" type="text" id="display_name">
								</div>
								...
								<div class="m-b25">
									...
									<input name="phone_number" required="" class="form-control" placeholder="phone number" type="text" id="phone_number">
								</div>

								<div class="m-b25">
									<label class="label-title">Age</label>
									<input name="dob" required="" class="form-control" placeholder="age" type="number" min="18" id="dob">
								</div>
								...
								<div class="m-b40">
									...
									<input name="password" required="" class="form-control" placeholder="Password" type="password" id="password">
								</div>
