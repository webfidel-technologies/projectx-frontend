			...
			<div class="main-bar clearfix">
				<div class="container-fluid clearfix">
					...
					<div class="logo-header me-md-5">
						<a href="index.html" class="logo-dark"><img src="images/logo.svg" alt="logo"></a>
						<a href="index.html" class="logo-light"><img src="images/logo-white.svg" alt="logo"></a>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="contact-info style-1 text-start text-white">
								...
								<p class="text wow fadeInUp" data-wow-delay="0.2s"><span class="text-decoration-underline text-white"><a class="text-white" href="our-team.html">MoonCart is here to help you;</a></span> <br> Our experts are available to answer any questions you might have. We’ve got the answers..</p>
